    ...
    <div>
        ...
        >
                ...
                <Row>
                    ...
                    <Col span="6">
                        <FormItem label="申请日期：" prop="date" class="formItemMargin">
                            <DatePicker v-model="formValidate.date" type="date" placeholder="请选择申请日期" class="widthPercentage" @on-change="getDateEvent"></DatePicker>
                        </FormItem>
                    </Col>
                    <Col span="6">
                        <FormItem label="生产车间：" prop="workshopId" class="formItemMargin">
                            <Select label-in-value v-model="formValidate.workshopId" placeholder="请选择生产车间" @on-change="getWorkshopEvent">
                                <Option v-for="item in saveModalWorkshopList" :value="item.deptId" :key="item.deptId">{{ item.deptName }}</Option>
                            </Select>
                        </FormItem>
                    </Col>
                    <Col span="6">
                        <FormItem label="班次：" class="formItemMargin" prop="shiftId">
                            <Select v-model="formValidate.shiftId" placeholder="请选择班次" @on-change="getShiftEvent">
                                <Option v-for="item in formValidate.shiftList" :value="item.shiftId" :key="item.shiftId">{{ item.shiftName }}</Option>
                            </Select>
                        </FormItem>
                    </Col>
                    <Col span="12">
                    ...
                    <Col span="12">
                        <FormItem label="备注：" class="formItemMargin">
                            <Input v-model="formValidate.remarks" type="textarea" :autosize="{ minRows: 1, maxRows: 1 }" placeholder="请输入..." :maxlength="remarksLength"/>
                        </FormItem>
                    </Col>
                </Row>
            ...
            <div slot="footer" class="modal-footer-box">
                <Button :disabled="isDisableConfirm" type="success" :loading="saveModalButtonLoading" @click="saveModalConfirmEvent"> 保存</Button>
                <Button type="info" class="margin-left-10" @click="saveAndSubmitEvent" :loading="saveAndSubmitButtonLoading">保存并提交</Button>
        ...
        data () {
            ...
            return {
                ...
                tableHeader: [
                    ...
                    {title: '规格', key: 'productModels', minWidth: 90},
                    {title: '生产工序', key: 'processName', minWidth: 90},
                    {
                        title: '单位',
                        key: 'unitName',
                        align: 'left',
