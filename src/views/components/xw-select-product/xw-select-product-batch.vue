    ...
    export default {
        ...
        data () {
            return {
                ...
                middleSelectList: [],
                onceEditSure: false,
                selectProductCodeNameMiddle: null
            };
        },
        methods: {
            remoteMethod (query) {
            ...
            async searchProductVal () {
                ...
                this.codeName = '';
                this.value1 = [];
                this.selectProductCodeNameMiddle = null;
            ...
            changeProduct (val) {
                if (!val) {
                    // debugger;
                    if (this.selectProductCodeNameMiddle) {
                        this.selectProductCodeName = this.selectProductCodeNameMiddle;
        ...
        watch: {
            selectProductCode (newData, oldData) {
                ...
                if (newData === null || newData === undefined || newData === '') {
                    _this.selectProductCodeName = '';
                    _this.$refs.setQuery.clearSingleSelect()
                } else if (newData === "1") {
                    // this.selectProductCodeName = this.selectProductCodeNameMiddle;
                    return;
                } else {
                    _this.$nextTick(() => {
                        _this.selectProductCodeNameMiddle = newData;
                        _this.selectProductCodeName = newData;
                    })
                }
            }
        }
