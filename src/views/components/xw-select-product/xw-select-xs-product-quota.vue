...
<script>
    ...
    export default {
        ...
        props: ['selectProductCode', 'processId'],
        data () {
            return {
                value1: [],
        ...
        methods: {
            ...
            dbClickSelectProduct (val, index) {
                this.isdbClick = true;
                this.curProductCodeName = val.codeName;
                this.selectProductCodeName = val.codeName;
            ...
            getProductList () {
                ...
                this.$call('product.list2', params).then(res => {
        ...
        watch: {
            selectProductCode (newData, oldData) {
                ...
                if (newData === null || newData === undefined || newData === '') {
                    ...
                    this.selectProductCodeName = newData.split('+++')[0];
                }
            }
        }
    };
