        ...
        <layout @on-select="selectMenu" :tabTitle="'维修状态'" :curTabStateId="curCompletionState" :stateList="orderStateList">
            <div slot="content">
                <div class="flexBetween" id="selectedHeight">
                    <div class="leftFlex">
                        <Button v-if="curCompletionState === 0 && this.rightItems.cancelCall" class="marginBottom marginButtonLeft" type="error" @click="cancelFaultCall">取消呼叫</Button>
                        <Button icon="md-close" v-if="curCompletionState === 2 && this.rightItems.close" class="marginBottom" type="error" @click="handleClose">关闭</Button>
                        <Button icon="md-swap" v-if="curCompletionState === 2 && this.rightItems.unclose" class="marginBottom marginButtonLeft" type="warning" @click="handleUnClose">撤销关闭</Button>
                    </div>
                    <div>
                        ...
                        <Button class="marginBottom" type="primary" icon="ios-search" @click="searchMachine">搜索</Button>
                    </div>
                </div>
                <Table :loading="repairMachineLoading" :height="tableHeight" @on-selection-change="selectRepairData" class="marginBottom" size="small" ref="selection" border :columns="repairMachineColumns" :data="repairMachineData"></Table>
                    ...
                    <div class="padding">
                        <div class="">
                            <Row>
                                ...
                                <Col span="8">
                                    <p><span class="spanTitle">呼叫类型：</span><span class="spanContent">{{ callClass === null ? '' : (callClass === 0 ? '手动' : '自动') }}</span></p>
                                </Col>
                            </Row>
                        </div>
                ...
                <div >
                    ...
                    <div class="padding">
                        <Form :show-message="false">
                            ...
                            <Row class="marginBottom">
                                <Col span="8">
                                    <p><span class="spanTitle">故障类别：</span><span class="spanBlock spanContent">{{ faultTypeName }}</span></p>
                                    <!--<p><span class="spanTitle">故障类别：</span><span>-->
                                        <!--{{ faultTypeName }}-->
                                    <!--</span></p>-->
                                </Col>
                                <Col span="8">
                                    <p><span class="spanTitle">故障小类：</span><span class="spanBlock spanContent">{{ faultSubclassName }}</span></p>
                                ...
                                <Col span="8">
                                    <p><span class="spanTitle">故障信息：</span><span class="spanBlock spanContent">{{ faultName }}</span></p>
                            ...
                            <Row class="marginBottom">
                                ...
                                <Col span="16">
                                    <p class="spanTitle"><span>维修描述：</span><span>
                                       <Input style="width: 395px;" v-model="repairDescription" type="textarea" :rows="1" placeholder="..." />
                                    </span></p>
