<template>
    <div>
        ...
        <p :class="className" :style="{textAlign: 'center', color: color, fontSize: countSize, fontWeight: countWeight}"><span v-cloak :id="idName">{{ startVal }}</span><span>{{ unit }}<span style="font-size: 16px;margin-left: 4px;">台</span></span></p>
    </div>
</template>
