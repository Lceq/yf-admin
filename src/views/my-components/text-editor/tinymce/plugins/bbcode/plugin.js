 ...
 */
  ...
  function (Tools) {
      ...
      // example: <strong> to [b]
          ...
          rep(/<font.*?color=\"(.*?)\".*?class=\"quoteStyle\".*?>(.*?)<\/font>/gi, '[quota][color=$1]$2[/color][/quota]');
          rep(/<font.*?class=\"codeStyle\".*?color=\"(.*?)\".*?>(.*?)<\/font>/gi, '[code][color=$1]$2[/color][/code]');
          rep(/<font.*?class=\"quoteStyle\".*?color=\"(.*?)\".*?>(.*?)<\/font>/gi, '[quota][color=$1]$2[/color][/quota]');
          ...
          rep(/<span class=\"quoteStyle\">(.*?)<\/span>/gi, '[quota]$1[/quota]');
          rep(/<strong class=\"codeStyle\">(.*?)<\/strong>/gi, '[code][b]$1[/b][/code]');
          rep(/<strong class=\"quoteStyle\">(.*?)<\/strong>/gi, '[quota][b]$1[/b][/quota]');
          rep(/<em class=\"codeStyle\">(.*?)<\/em>/gi, '[code][i]$1[/i][/code]');
          rep(/<em class=\"quoteStyle\">(.*?)<\/em>/gi, '[quota][i]$1[/i][/quota]');
          rep(/<u class=\"codeStyle\">(.*?)<\/u>/gi, '[code][u]$1[/u][/code]');
          rep(/<u class=\"quoteStyle\">(.*?)<\/u>/gi, '[quota][u]$1[/u][/quota]');
          rep(/<\/(strong|b)>/gi, '[/b]');
          rep(/<(strong|b)>/gi, '[b]');
          rep(/<\/(em|i)>/gi, '[/i]');
          rep(/<(em|i)>/gi, '[i]');
