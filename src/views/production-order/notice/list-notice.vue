                        ...
                        <Col>
                            <Row type="flex" justify="end">
                                <Col class="margin-bottom-10 padding-left-4">
                                    <DatePicker type="date" placeholder="请选择计划开工时间" class="query-bar-input-width" v-model="queryBarDateFrom"></DatePicker>
                                </Col>
                                <Col class="margin-bottom-10 padding-left-4">
                                    <DatePicker type="date" placeholder="请选择计划完工时间" class="query-bar-input-width" v-model="queryBarDateTo"></DatePicker>
                                </Col>
                                <Col class="margin-bottom-10 padding-left-4">
                                    <Select clearable v-model="queryBarWorkshopValue" class="query-bar-input-width" placeholder="请选择生产车间">
                                        <Option v-for="item in queryBarWorkshopList" :value="item.deptId" :key="item.deptId">{{ item.deptName }}</Option>
                                    </Select>
                                </Col>
                                <Col class="margin-bottom-10 padding-left-4">
                                    <Select clearable v-model="queryBarProcessTypeValue" class="query-bar-input-width" placeholder="请选择所属工段" @on-change="getProcessTypeEvent">
                                        <Option v-for="item in queryBarProcessTypList" :value="item.id" :key="item.id">{{ item.name }}</Option>
                                    </Select>
                                </Col>
                                <Col class="margin-bottom-10 padding-left-4">
                                    <Select clearable v-model="queryBarProcessValue" class="query-bar-input-width" placeholder="请选择生产工序">
                            ...
                            <Row type="flex" justify="end" v-show="showMore">
                                <Col class="margin-bottom-10 padding-left-4">
                                    <Input type="text" v-model="queryBarOrderCodeValue" class="query-bar-input-width" placeholder="请输入生产单号"/>
                                </Col>
                                <Col class="margin-bottom-10 padding-left-4">
                                    <Input type="text" v-model="queryBarNoticeValue" class="query-bar-input-width" placeholder="请输入通知单号"/>
                                </Col>
                                <Col class="margin-bottom-10 padding-left-4">
                                    <Input type="text" v-model="queryBarMaterielValue" class="query-bar-input-width" placeholder="请输入产品编码或名称"/>
                                </Col>
                                <Col class="margin-bottom-10 padding-left-4">
                                    <Input type="text" v-model="queryBarBatchCodeValue" class="query-bar-input-width queryBarMarginRight" placeholder="请输入批号"/>
                                </Col>
                                <Col class="flexAlignCenter margin-bottom-10">
                                    <!--<p class="labelWidth">引用状态:</p>-->
                                    <Select clearable v-model="queryBarStartState" placeholder="请选择开台状态" class="query-bar-input-width">
                                        <Option v-for="item in startStateList" :value="item.id" :key="item.id">{{ item.name }}</Option>
                                    </Select>
                                </Col>
                            </Row>
                        </Col>
