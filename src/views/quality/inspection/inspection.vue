        ...
        <Card>
            <div>
                <Row class="flexBetween" id="selectedHeight">
                    <Col class="leftFlex">
                        <Button icon="md-add" class="buttonBottom" @click="addNewQmSearch" type="primary">新增</Button>
                        ...
                        <Row class="flexBetween">
                            ...
                            <Col>
                                <div class="leftFlex">
                                    ...
                                    <Button icon="ios-search" class="marginBottom marginButtonLeft" type="primary" @click="searchQmSearch">搜索</Button>
                                </div>
                            </Col>
                        </Row>
                    </Col>
...
<script>
import inspection from './inspectionJs';
export default{
    // created () {
