        ...
        <Card>
            <Row class="flexBetween" id="selectedHeight">
                ...
                <Col>
                    ...
                    <!--</Select>-->
                    <!--<Input class="formWidth marginBottom" type="text" v-model="codeName" placeholder="输入产品编码或名称"/>-->
        ...
        >
            <div slot="content">
                ...
                <div class="marginBottom">
                    <h4>辅助计件标准</h4>
                    <Table :height="400" border :data="fixedList" :columns="fixedColumns"></Table>
                </div>
                <div v-if="editId">
...
<script>
    import pieceQuota from './auxiliary-quota';
    export default {
        ...pieceQuota,
        name: 'piece-quota'
    };
