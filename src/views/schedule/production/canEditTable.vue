...
<template>
    <div>
        <Table :ref="refs" :height="600" :loading="dataDutyLoading" :columns="columnsList" :data="thisTableData" border disabled-hover></Table>
    </div>
</template>
...
export default {
    ...
    watch: {
        ...
        dutyLoading (newData, oldData) {
            // debugger
            this.dataDutyLoading = newData;
        }
    }
};
</script>
